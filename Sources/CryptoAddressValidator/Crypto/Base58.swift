...
//        var result = zero
//        var i = BigUInt(1)
//        let byteString = [UInt8](text.utf8)
//
//         for char in byteString.reversed() {
//           guard let alphabetIndex = alphabet.firstIndex(of: char) else {
//               throw CryptographyError.nonBase58Character
//           }
//           result += (i * BigUInt(alphabetIndex))
//           i *= radix
//         }
//
